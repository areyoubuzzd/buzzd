/**
 * Unified Production Server for Buzzd App
 * This file combines both API and static serving in a single server
 */
...
console.log(`
=================================================
  BUZZD UNIFIED PRODUCTION SERVER (STARTED: ${new Date().toISOString()})
=================================================
...
// Helper function to convert Singapore time
...
// 5. User endpoint for session information
...
let clientPath = clientPaths.find(path => fs.existsSync(path) && fs.lstatSync(path).isDirectory());
